...
Esta pasta concentra os acordos tecnicos iniciais do projeto.
...
- `equipe/matheus.md`: escopo de desenvolvimento do Matheus.
- `equipe/marcelo.md`: escopo de desenvolvimento do Marcelo.
