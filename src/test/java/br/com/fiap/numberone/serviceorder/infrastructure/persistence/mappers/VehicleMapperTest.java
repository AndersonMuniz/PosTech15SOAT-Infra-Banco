...
import br.com.fiap.numberone.veiculo.domain.entities.*;
...
//        assertEquals("cliente-1", entity.getIdClient());
//    }

//    @Test
//    void deveMapearVeiculoEntityParaVehicle() {
//        UUID id = UUID.randomUUID();
//        VehicleEntity entity = new VehicleEntity(id, "ABC1D23", "Fiat", "Argo", 2024,
